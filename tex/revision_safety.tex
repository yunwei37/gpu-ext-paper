...
% TODO(Q2): retain strict-mode rejection-before-launch and positive execution
% controls in the actual device-policy runtime, then update the deployment
% statement only if that evidence changes. Current build-cuda-pr503 has
% ENABLE_EBPF_VERIFIER=OFF; CPU tests alone do not close this requirement.
