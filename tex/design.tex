...
\subsection{Runtime: Verification, Optimizations, and Hierarchical Maps}
...
We define explicit, relaxed consistency semantics using bounded freshness epochs, ensuring GPU-side updates propagate consistently and efficiently to host-side consumers. This abstraction allows developers to express complex cross-layer logic (e.g., GPU-side region access tracking informing host-side eviction policies) using simple eBPF APIs without explicit synchronization overhead.
