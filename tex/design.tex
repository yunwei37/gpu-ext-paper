...
Device policies can be triggered at given memory operations, receive a compact warp‑uniform context. Operations like prefetch can be performed on device and then trigger host-side prefetch handlers, enabling the host to combine cross‑kernel information with device‑side predictive logic. 
...
// Device-side helpers
// Request prefetch, triggers handler in kernel
