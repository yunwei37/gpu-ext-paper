...
Our measurements show per-access latency slowdown under
...
\toprule
\textbf{Tool} & \textbf{LOC} & \textbf{Domain} & \textbf{\sys Overhead} & \textbf{vs NVBit} \\
\midrule
...
Comparing \sys-based tools against CUPTI and NVBit for common profiling tasks across GEMM, SpMV, and stencil kernels shows significant performance advantages. CUPTI-based profiling incurs 15--25\%
...
\paragraph{Device-side Optimization.}
