...
We evaluated \sys on two machines.\xiangyu{There is only one machine here?} Server~A is a single-socket Intel Core
Ultra~9 285K processor (24 cores) with 128~GB DDR5 RAM and an NVIDIA RTX~5090
GPU.  average each metric over
10 trials; when averaging speedups we use geometric meaernel and Device Runtime.s. We compare against
default UVM
...
\toprule
\textbf{Tool} & \textbf{LOC} & \textbf{Domain} & \textbf{\sys Overhead} & \textbf{NVBit Overhead} \\
\midrule
