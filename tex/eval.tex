...
\begin{tabularx}{\columnwidth}{@{} X l c c @{}}
\toprule
\textbf{Tool} & \textbf{LOC} & \textbf{Domain} & \textbf{Overhead(\sys vs baseline vs Nvbit)} \\
\midrule
kernelretsnoop & 153 & Device & \\
threadhist & TBD & Device & 3\% vs -- vs 86\% \\ 
...
\bottomrule
\end{tabularx}
\caption{\sys-based observability tools.\xiangyu{Add one column to say its functionality?}}
