...
\begin{figure}
\centering
\fbox{\parbox{\columnwidth}{\centering [Figure: BFS Scheduler Comparison]}}
...
\begin{figure}
\centering
\fbox{\parbox{\columnwidth}{\centering [Figure: Latency comparison of static CPU GPU slice percentage]}}
\caption{Latency comparison of static CPU GPU slice percentage}\label{fig:slicing-percentage}
\end{figure}
\begin{figure}
\centering
\fbox{\parbox{\columnwidth}{\centering [Figure: LLAMA2 hidden representation Heatmap on Server A]}}
\caption{LLAMA2 hidden representation Heatmap on Server A}\label{fig:heatmap}
\end{figure}
\begin{figure}
\centering
\fbox{\parbox{\columnwidth}{\centering [Figure: LLAMA2 hidden representation Heatmap on Server B]}}
\caption{LLAMA2 hidden representation Heatmap on Server B}\label{fig:heatmap1}
\end{figure}
\begin{figure}
\centering
\fbox{\parbox{\columnwidth}{\centering [Figure: LLAMA2 Power Generation Full CPU Full GPU offload]}}
