...
3. Evaluation
   ...
   - Added RTX 5090 comparisons (Fig. 16) and trampoline-scaling measurements (Section 5.3). The evaluated observability tools incur lower overhead than NVBit, while shorter kernels incur higher relative trampoline overhead.
