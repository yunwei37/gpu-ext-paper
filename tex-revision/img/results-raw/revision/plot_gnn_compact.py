...
DATA_DIR = Path(__file__).resolve().parents[6] / "workloads" / "pytorch"

# Data directories
RESULT_DIRS = {
    # Baseline - No UVM
    "No UVM (Baseline)": DATA_DIR / "without-user-prefetch" / "result_no_uvm1",
    # Without prefetch
    "UVM (no prefetch)": DATA_DIR / "without-user-prefetch" / "result_uvm_baseline1",
    "UVM (no prefetch) gpubpf": DATA_DIR / "without-user-prefetch" / "result_uvm_ebpf1",
    # With prefetch
    "UVM (prefetch)": DATA_DIR / "with-user-prefetch" / "result_uvm_baseline",
    "UVM (prefetch) gpubpf": DATA_DIR / "with-user-prefetch" / "result_uvm_ebpf",
}
...
def main():
    ...
    # Retain the original plot style and data with a shorter plotting area.
    ...
    # Save figure
    output_path = BASE_DIR / "gnn-compact.png"
    plt.savefig(output_path, dpi=150, bbox_inches='tight')
    print(f"\nSaved figure to: {output_path}")

    pdf_path = BASE_DIR / "gnn-compact.pdf"
