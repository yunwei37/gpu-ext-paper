...
For LMCache's cuFile backend in compatibility mode, an agent-developed policy prioritizes reads and defers background writes within a 200~ms cumulative budget.
% 对 LMCache 的 cuFile 后端兼容模式，智能体开发的策略优先处理读取，并在累计 200 ms 的预算内延迟后台写入。
