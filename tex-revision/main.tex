...
We implemented \sys{} on the Linux NVIDIA GPU driver and find that AI-generated policies improve throughput by $1.76\times$ over application-tuned baselines and reduce tail latency by up to $2\times$, without application modifications. The \sys{} mechaism costs 0.7--3.3\% overhead when executing the same policy reproduce from
other works.
