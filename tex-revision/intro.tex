...
\begin{itemize}[leftmargin=*,itemsep=0pt]
  ...
  \item an evaluation across four GPU workloads, where \sys{} policies improve throughput by up to $4.8\times$ and reduce tail latency by up to $2\times$, with all 59 policies generated by AI agents and no OS kernel panics.
