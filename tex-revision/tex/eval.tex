...
\texttt{launchlate} is reported on the P40; its host/device cross-clock measurement on the RTX~5090 remains under validation.
% \texttt{launchlate} 在 P40 上报告；其在 RTX~5090 上的主机/设备跨时钟测量仍在验证中。
